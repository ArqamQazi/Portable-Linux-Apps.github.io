(function() {
  ...
  fetch( '/Portable-Linux-Apps.github.io/app/' + encodeURIComponent(name) + '.json')
    .then(function(r) {
    ...
    .then(function(app) {
      ...
      html += '<img src="' + iconUrl + '" alt="icon for ' + escapeHtml(app.name || name) + '" onerror="this.src=\'../../Portable-Linux-Apps.github.io/no-icon.webp\'">';
