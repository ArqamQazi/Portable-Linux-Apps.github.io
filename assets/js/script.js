...
function renderApps(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    html += '<img loading="lazy" src="/Portable-Linux-Apps.github.io/icons_48/' + encodeURIComponent(app.name) + '.webp" width="48" height="48" alt="icon for ' + escapeHtml(app.name) + '" onerror="this.onerror=null;this.src=\'/Portable-Linux-Apps.github.io/no-icon_48.webp\'" class="app-icon">';
    html += '<div class="app-body">';
    html += '<a href="/Portable-Linux-Apps.github.io/' + lang_value + '/app/' + encodeURIComponent(app.name) + '.html" class="app-name"><strong>' + escapeHtml(app.name) + '</strong></a>';
